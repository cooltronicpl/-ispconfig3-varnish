...
Your site is fast as rocket also with WP Rocket, Proxy Cache Purge on WordPress, and CoolTRONIC.pl Varnish Cache Purge on CraftCMS. This mechanism also enables brotli on WordPress with WP Rocket and eaisly respecting of Apache2 .htaccess rules from many WordPress or CraftCMS plugins.
