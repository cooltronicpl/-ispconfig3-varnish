...
```
3. Comment last line in apache 2 file ```/etc/apache2/ports.conf``` example in nano or vim ```#Listen 443``` or remove all, there should not be any ```Listen 443``` in ports.conf
