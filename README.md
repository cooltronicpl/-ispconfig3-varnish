...
Your site is fast as rocket also with WP Rocket. We have some mechnism of automatic Varnish clearing with external plugins like Proxy Cache Purge on WordPress, and CoolTRONIC.pl Varnish Cache Purge on CraftCMS. This mechanism also enables brotli compression on WordPress with WP Rocket and eaisly respecting of Apache2 .htaccess rules from many WordPress or CraftCMS plugins.
